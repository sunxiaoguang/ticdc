...
func (d *CanalEventBatchEncoder) EncodeDDLEvent(e *model.DDLEvent) (*MQMessage, error) {
	...
	return NewMQMessage(nil, b, e.CommitTs, model.MqMessageTypeDDL, &e.TableInfo.Schema, &e.TableInfo.Table), nil
}
...
func (d *CanalEventBatchEncoder) Build() []*MQMessage {
	...
	ret := NewMQMessage(nil, value, 0, model.MqMessageTypeRow, nil, nil)
	d.messages.Reset()
	d.resetPacket()
